...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            @can('Create Commission Claim')
                buttons.push({
                    text: "Create New Commission Claim",
                    attr: {
                        title: "Create",
                        id: "create"
                    },
                    ...
                    action: function(e, dt, node, config) {
                        window.location.href = "{{ route('commission-claims.create') }}";
                    }
                });
            @endcan
            ...
            var table = $(table_claim).DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        @can('View Commission Claim')
                            buttons +=
                                `<a href="/commission-claims/${row.id}" class="btn btn-info viewBtn">View</a>&nbsp;`;
                        @endcan

                        @can('Delete Commission Claim')
                            buttons +=
