...
<head>
    <meta charset="utf-8">
    <title>Credit Note - {{ $credit_note->credit_note_number }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="quotation-details">
        <div class="quotation-date left">
            <p><strong>Date:</strong> {{ \Carbon\Carbon::parse($credit_note->credit_note_date)->format('d M Y') }}</p>
        </div>
        <div class="right">
            <div>
                <p><strong>Credit Note:</strong> {{ $credit_note->credit_note_number }}</p>
            </div>
        </div>
    ...
    <div class="details">
        <div class="client-details left">
            <p><strong>Client:</strong> {{ $credit_note->client->name ?? '-' }}</p>
            <p><strong>Phone:</strong> {{ $credit_note->client->mobileno ?? '-' }}</p>
        </div>
    </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ number_format($credit_note->credit_amount,2) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
