...
<body>
    ...
    <div class="details">
        ...
        {{-- <div class="banking-details right">
            ...
            <p>Reference: <strong>{{ $quotation->quotation_number }}</strong></p>
        </div> --}}
    </div>
            ...
            <table>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="text-align: right;">RM {{ number_format($quotation->items->sum('subtotal'), 2) }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;"><strong>RM
                                {{ number_format($quotation->final_price, 2) }}</strong></td>
                    </tr>
                </tfoot>
            </table>
        </div>
