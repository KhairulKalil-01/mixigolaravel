...
<body>
    ...
    <div class="quotation-details">
        <div class="quotation-date left">
            <p><strong>Date:</strong> {{ \Carbon\Carbon::parse($refund->refund_date)->format('d M Y') }}</p>
        </div>
        <div class="right">
            < <p><strong>Refund Number:</strong> {{ $refund->refund_number }}</p>
        </div>
    </div>
    ...
    <div class="details">
        <div class="client-details left">
            <p><strong>Client:</strong> {{ $refund->creditNote->client->name ?? '-' }}</p>
            <p><strong>Phone:</strong> {{ $refund->creditNote->client->mobileno ?? '-' }}</p>

        </div>
        <div class="banking-details right">
            <div><strong>Refund To:</strong></div>
            <p>Bank: {{ $refund->bank->bank_name }}</p>
            <p>Acc Number: {{ $refund->bank_account }}</p>
        </div>
    </div>
